...
<?php
	...
	<tr><td><label>Mon avatar :</label></td><td><input type="file" name="avatar" id="fichier"></td></tr>
	<tr><td></td></tr>
	<tr><td></td><td><input type="submit" value="Mettre à jour mon profil" id="bouton"></td></tr>
	</table>
	</form>
	<?php 
 if (isset($erreur)){
